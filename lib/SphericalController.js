...
var SphericalController = /** @class */ (function (_super) {
    ...
    function SphericalController(camera, target) {
        ...
        (_a = (_b = _this._cameraTarget).material) !== null && _a !== void 0 ? _a : (_b.material = new three_2.MeshBasicMaterial({
            color: 0xff0000,
            opacity: 0.0,
            transparent: true,
        }));
    ...
    SphericalController.prototype.moveTarget = function (value, option) {
        option = EasingOption_1.EasingOption.init(option, this);
        var tween = new tween_js_1.Tween(this._cameraTarget.position)
    ...
    SphericalController.prototype.loop = function (type, min, max, option) {
        ...
        toObjMin[type] = toMin;
        var loop = function () {
            var tween = new tween_js_1.Tween(_this.pos)
        ...
        var tween = new tween_js_1.Tween(this.pos)
            .easing(option.easing)
    ...
    SphericalController.prototype.moveCameraShift = function (value, option) {
        option = EasingOption_1.EasingOption.init(option, this);
        var tween = new tween_js_1.Tween(this.cameraShift)
            .easing(option.easing)
            .to({ x: value.x, y: value.y, z: value.z }, option.duration)
            .onUpdate(this.dispatchUpdateEvent)
            .start();
    ...
    SphericalController.prototype.addTargetPosition = function (pos, overrideTween) {
        if (overrideTween === void 0) { overrideTween = false; }
